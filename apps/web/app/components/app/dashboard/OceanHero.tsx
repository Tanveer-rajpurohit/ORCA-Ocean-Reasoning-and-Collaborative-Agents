...
export function OceanHero({
  ...
  return (
    <section className="rounded-xl bg-brand text-white mb-8">
      <div className="p-6 sm:p-7 lg:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-white/12 rounded-lg overflow-hidden mt-8">
          {metrics.map((metric) => (
            <div key={metric.label} className="bg-brand px-4 py-3.5">
        ...
        <div className="flex flex-wrap items-center gap-2.5 mt-7">
          <Link
            href="/map"
            className="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg bg-white text-brand text-xs font-semibold hover:bg-white/90 active:scale-[0.97] transition-all duration-150"
          >
          ...
          <Link
            href="/advisories"
            className="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg border border-white/25 text-xs font-medium text-white/90 hover:bg-white/10 active:scale-[0.97] transition-all duration-150"
          >
